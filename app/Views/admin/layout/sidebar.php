<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">Hi Valeeqa</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html"><img src="<?= base_url() ?>/assets/img/logo-hv.svg"></a>
        </div>
        <ul class="sidebar-menu">
            <li class="active"><a class="nav-link" href="<?= base_url() ?>/admin/index"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
