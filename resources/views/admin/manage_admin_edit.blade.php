        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="needs-validation" novalidate="" action="{{ url('edit-admin') }}" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" required="" name="username"
                                                   data-name="username" value="{{ $user->username }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="jk" class="form-control" name="gender">
                                                ...
                                                <option value="P" <?php echo $user->gender == 'P' ? 'selected' : '' ?>>
                                                    Perempuan
                                                </option>
                                                <option value="L" <?php echo $user->gender == 'L' ? 'selected' : '' ?>>
                                                    Laki
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group mb-0 row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" required=""
                                                      name="alamat">{{ $user->address }}</textarea>
                                        </div>
                                    </div>
                                </div>
