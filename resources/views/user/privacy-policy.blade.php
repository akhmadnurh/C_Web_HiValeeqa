        ...
        <div class="container py-5 d-flex align-items-center justify-content-center">
            <div class="card border-radius-1">
                <div class="card-body p-5"
                    ...
                    <h1>Privacy Policy for Hi Valeeqa</h1>

                    <p>At Hi Valeeqa, accessible from hivaleeqa.com, one of our main priorities is the privacy of our
                        visitors. This Privacy Policy document contains types of information that is collected and recorded
                        by Hi Valeeqa and how we use it.</p>
                    ...
                    <p>Hi Valeeqa follows a standard procedure of using log files. These files log visitors when they visit
                    ...
                    <p>Like any other website, Hi Valeeqa uses 'cookies'. These cookies are used to store information
                    ...
                    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Hi
                        Valeeqa.</p>

                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                        are used in their respective advertisements and links that appear on Hi Valeeqa, which are sent
                    ...
                    <p>Note that Hi Valeeqa has no access to or control over these cookies that are used by third-party
                        advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>Hi Valeeqa's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                    ...
                    <p>Hi Valeeqa does not knowingly collect any Personal Identifiable Information from children under the
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                        with regards to the information that they shared and/or collect in Hi Valeeqa. This policy is not
