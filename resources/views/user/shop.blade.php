        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <form action="{{ url('shop') }}" class="w-75" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" placeholder="Minimal" class="form-control mb-3" name="min">
                            <input type="number" placeholder="Maximal" class="form-control mb-3" name="max">
                        </div>
                        ...
                        @foreach($products as $product)
                            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-3">
                                <div class="card border-0" style="height: 30rem;">
                                    ...
                                    <div class="card-body">
                                        <a href="{{ url('detail').'/'.$product->product_id }}">
                                            <h6 class="card-title text-center text-uppercase text-pink-dark">{{ $product->product_name }}</h6>
