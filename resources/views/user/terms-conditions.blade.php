        ...
        <div class="container py-5 d-flex align-items-center justify-content-center">
            <div class="card border-radius-1">
                <div class="card-body p-5"
                    ...
                    <p>Welcome to Hi Valeeqa!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of Hi Valeeqa's Website,
                        located at hivaleeqa.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Hi
                        Valeeqa if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>We employ the use of cookies. By accessing Hi Valeeqa, you agreed to use cookies in agreement with
                        the Hi Valeeqa's Privacy Policy.</p>
                    ...
                    <p>Unless otherwise stated, Hi Valeeqa and/or its licensors own the intellectual property rights for all
                        material on Hi Valeeqa. All intellectual property rights are reserved. You may access this from Hi
                        Valeeqa for your own personal use subjected to restrictions set in these terms and conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Hi Valeeqa</li>
                        <li>Sell, rent or sub-license material from Hi Valeeqa</li>
                        <li>Reproduce, duplicate or copy material from Hi Valeeqa</li>
                        <li>Redistribute content from Hi Valeeqa</li>
                    </ul>

                    <p>This Agreement shall begin on the date hereof.</p>

                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                        certain areas of the website. Hi Valeeqa does not filter, edit, publish or review Comments prior to
                        their presence on the website. Comments do not reflect the views and opinions of Hi Valeeqa,its
                        agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                        and opinions. To the extent permitted by applicable laws, Hi Valeeqa shall not be liable for the
                    ...
                    <p>Hi Valeeqa reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant Hi Valeeqa a non-exclusive license to use, reproduce, edit and authorize others to
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                        ...
                        the absence of Hi Valeeqa; and (d) the link is in the context of general resource information.</p>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                        website, you must inform us by sending an e-mail to Hi Valeeqa. Please include your name, your
                    ...
                    <p>No use of Hi Valeeqa's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
